...
export default observer(function AccountDeposit() {

    const { accountStore } = useStore();
    const { selectedAccount, createAccount, depositAccount, loading, loadAccount, loadingInitial } = accountStore;
    ...
    function handleFormSubmit(account: Account) {
            account.balance = Number(old_balance.current) + Number(account.balance); //string concatenation somehow
            depositAccount(account).then(() => navigate(`/accounts`));
    }
                ...
                {({ handleSubmit, isValid, isSubmitting, dirty }) => (
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        <Button
                            ...
                            loading={loading} floated='right' positive type='submit' content='Deposit' />
